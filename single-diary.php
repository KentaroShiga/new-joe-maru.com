<?php
/**
 * The template for displaying single diary posts
 *
 * @package JOEMARU
 * @subpackage JOEMARU
 * @since JOEMARU 1.0
			...
			<article class="single-post-article">
				...
				<header class="single-post-header">
					<div class="single-header-icon">
						<img src="<?php echo get_template_directory_uri(); ?>/images/h1-icon.webp" alt="日記アイコン" />
					</div>
				...
				<nav class="single-post-nav">
						...
						<?php if ($prev_post) : ?>
							<div class="single-nav-prev">
								<a href="<?php echo get_permalink($prev_post->ID); ?>">
									<span class="nav-label">前の日記</span>
						...
						<?php if ($next_post) : ?>
							<div class="single-nav-next">
								<a href="<?php echo get_permalink($next_post->ID); ?>">
									<span class="nav-label">次の日記</span>
					...
					<div class="single-back-to-archive">
						<a href="<?php echo home_url('?post_type=diary'); ?>" class="back-link">
							日記一覧に戻る
						</a>
					</div>
				</nav>
